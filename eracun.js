...
streznik.post('/izpisiRacunBaza', function(zahteva, odgovor) {
  ...
  form.parse(zahteva, function (napaka1, polja, datoteke) {
    ...
    var n = polja.seznamRacunov;
    pesmiIzRacuna(n, function(pesmi){
      
      strankaIzRacuna(n, function(stranka){
...
streznik.post('/prijava', function(zahteva, odgovor) {
  ...
  form.parse(zahteva, function (napaka1, polja, datoteke) {
    ...
    try {
      ...
      napaka2 = true;
      prikazi = "Prišlo je do napake pri registraciji nove stranke. Prosim preverite vnešene podatke in poskusite znova.";
    }
    
    if (napaka2 != true) {
      prikazi = "Stranka je bila uspešno registrirana.";
    }
    odgovor.redirect('/prijava'); 
  });
})
...
streznik.get('/prijava', function(zahteva, odgovor) {
  vrniStranke(function(napaka1, stranke) {
      vrniRacune(function(napaka2, racuni) {
        odgovor.render('prijava', {sporocilo: prikazi, seznamStrank: stranke, seznamRacunov: racuni});  
      }) 
    });
})
...
streznik.post('/stranka', function(zahteva, odgovor) {
  ...
  form.parse(zahteva, function (napaka1, polja, datoteke) {
    trenutnaStranka = polja.seznamStrank; 
    odgovor.redirect('/')
  });
})
